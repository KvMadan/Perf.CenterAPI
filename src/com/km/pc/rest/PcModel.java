...
public class PcModel
{
  ...
  public PcModel(String pcServerName, String almUserName, String almPassword, String almDomain, String almProject, String testId, String testInstanceId, String timeslotDurationHours, String timeslotDurationMinutes, PostRunAction postRunAction, boolean vudsMode, String description)
  {
...
*/
  ...
  {
    return String.format("[PCServer='%s', User='%s', %s", new Object[] { runParamsToString().substring(1) });
  }
  ...
  public String runParamsToString()
  {
    ...
    return String.format("[Domain='%s', Project='%s', TestID='%s', TestInstanceID='%s', TimeslotDuration='%s', PostRunAction='%s'%s]", new Object[] { this.almDomain, this.almProject, this.testId, this.testInstanceId, this.timeslotDuration, this.postRunAction.getValue(), vudsModeString });
  }
}